function getDescription() {
  return `
  A point <b>P</b> on a circle has several trigonometric identities. The
  <black>hypotenuse</black> is the circle's radius, with the <red>sine</red> and
  <blue>cosine</blue> being the point's projection onto the y and x axes,
  respectively. From those, we get the <mistyrose>"enclosing right triangle"</mistyrose>
  with the circle's center as the right angle corner, the <darkblue>secant</darkblue>
  (which is just <blue>1/cosine</blue>) as the x-axis corner, and the
